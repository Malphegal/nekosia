<div class="container">
    ...
    <ol>
        ...
        <li>N'oubliez jamais que la personne de l'autre côté est un être humain.</li>
        <li>Attention aux propos que vous employez envers les autres.</li>
        <li>Ce que vous postez n'est autre que le reflet de vous même. Tenez-en compte.</li>
        <li>Ne postez pas un message dans le seul butd e faire remarquer les fautes de frappe ou d’orthographe des autres. Ce comportement n'est pas apprécier des autres.</li>
        <li>Ne postez pas de message uniquement dans un but publicitaire. Néanmoins, un lien vers un site personnel peut être inclus dans la signature, à condition que le message placé au dessus soit pertinent au topic et ne serve pas d’alibi à une démarche purement publicitaire.</li>
    </ol>
</div>